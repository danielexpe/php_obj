...
$menu1 = new menu();
$menu1->setHeader("../Main Menu/User Menu");
$menu1->addItem("View user");
$menu1->addItem("Change user");
$menu1->addItem("Reset user");
$menu1->addItem("Record user");
$menu1->addItem("Exit");

$action1 = new action();
$action1->addAction("ls view_user.txt");
$action1->addAction("ls change_user.txt");
$action1->addAction("ls reset_user.txt");
$action1->addAction("ls record_user.txt");
